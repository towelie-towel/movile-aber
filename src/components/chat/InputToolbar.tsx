...
const GiftedChatScreen = (props: GiftedChatScreenProps) => {
    ...
    const styles = StyleSheet.create({
        ...
        input: {
            ...
            color: Colors[colorScheme ?? "light"].background_light1,
            flex: 3,
            fontSize: 16,
            height: 55 - 0.1 * 55,
            alignSelf: 'center',
        ...
        rightIconButtonStyle: {
            ...
            marginLeft: 5 - 0.1 * 5,
            borderLeftWidth: 0,
            borderLeftColor: Colors[colorScheme ?? "light"].border, // #fff
        },
        swipeToCancelView: {
            flexDirection: 'row',
            alignItems: 'center',
        ...
        sendButton: {
            ...
            backgroundColor: Colors[colorScheme ?? "light"].border_light_i,
            height: 55 - 0.1 * 55,
            width: 55 - 0.1 * 55,
            alignItems: 'center',
            justifyContent: 'center',
