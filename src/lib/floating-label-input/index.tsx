...
const FloatingLabelInput: React.ForwardRefRenderFunction<InputRef, Props> = (
  ...
  const imgSource = darkTheme
    ? secureText
      ? customShowPasswordImage || require('../../../assets/lib/make_visible_black.png')
      : customHidePasswordImage || require('../../../assets/lib/make_invisible_black.png')
    : secureText
      ? customShowPasswordImage || require('../../../assets/lib/make_visible_white.png')
      : customHidePasswordImage || require('../../../assets/lib/make_invisible_white.png');
