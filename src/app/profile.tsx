...
import { Animated, useWindowDimensions, Platform, TouchableOpacity, View, Text } from 'react-native';
  ...
  return (
    <View className='flex-1 bg-white'>
      <View style={{ marginTop: insets.top }} className='bg-white flex-1'>
        ...
        {Platform.OS === "ios" && <>
          <Animated.View style={{
            ...
            <BlurView style={{
              ...
              shadowRadius: 3.84,
              elevation: 5,
            }} tint="light" intensity={100}>
              <Animated.View style={{ position: "absolute", width: animSize, height: animSize, top: 0, left: animPosX, padding: animPadding }}>
              ...
              <View style={{ flexDirection: "row", justifyContent: "space-between", width: "100%", position: "absolute", bottom: 18, paddingHorizontal: 18 }}>
                <Animated.View style={{ opacity: animOpacity }}>
                  <Text className="text-[#e6e6e6] text-2xl font-medium">{"Julio Lopez"}</Text>
                </Animated.View>
                <ScaleBtn
                  style={{ justifyContent: 'center', alignSelf: 'flex-end', minWidth: 100, top: 8 }}
                  onPress={() => {
                    router.push("/stack/editprofile/")
                  }}
                >
                  <Animated.View style={{ height: 40, backgroundColor: bgColorAnim, borderRadius: 25, alignItems: "center", justifyContent: "center" }}>
                    <Animated.Text style={{ fontWeight: "600", fontSize: 18, color: textColorAnim, padding: 4 }}>
                      Edit
                    </Animated.Text>
                  </Animated.View>
                </ScaleBtn>
        ...
        <Animated.ScrollView
          style={{ backgroundColor: "#fff", marginTop: Platform.OS === "ios" ? animMarginTop : insets.top, overflow: "visible" }}
        ...
        >
          {Platform.OS === "ios" && <Animated.View style={{ height: animHeightCover }}></Animated.View>}
          {Platform.OS === "android" && <View style={{
            ...
            <View style={{ width: "100%", height: dimensions.width }}>
              <Image source={"https://lh3.googleusercontent.com/a/AAcHTtfPgVic8qF8hDw_WPE80JpGOkKASohxkUA8y272Ow=s1000-c"} alt={'avatar'} style={{ width: "100%", height: "100%" }} />
            </View>
            <View style={{ flexDirection: "row", justifyContent: "space-between", width: "100%", position: "absolute", bottom: 18, paddingHorizontal: 18 }}>
              <View style={{}}>
                <Text className="text-[#e6e6e6] text-2xl font-medium">{"Julio Lopez"}</Text>
              ...
              >
                <View className='flex-row items-center justify-center bg-white rounded-3xl'>
                  <Text className='font-bold text-md text-black p-2'>
                    Edit
                  </Text>
                </View>
              </ScaleBtn>
